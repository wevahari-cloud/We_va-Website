        ...
        <>
            ...
            <div className="lg:hidden flex items-center gap-2">
                ...
                <Sheet open={isOpen} onOpenChange={setIsOpen}>
                    ...
                    <SheetContent side="right" className="w-[300px] sm:w-[400px] bg-[#005DAA] border-l-white/10 text-white p-0">
                        <div className="h-full flex flex-col p-6 overflow-y-auto">
                            ...
                            <nav className="flex flex-col gap-6 flex-1">
                                ...
                                <div className="flex flex-col gap-3 mt-auto pt-8 pb-4">
                                    <Button asChild variant="secondary" className="w-full bg-white text-[#005DAA] hover:bg-gray-100 font-bold text-md h-12 shadow-md">
